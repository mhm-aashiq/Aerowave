      ...
      <div className="container">
        ...
        <div className='row'>
          <div className='col-lg-6 col-md-12 col-sm-12 '>
            <h1>Contact Us</h1>
            <p className="intro text-primary par">We'd Love to Hear from You!</p>
            <p className="intro par">Whether you have a question, a suggestion, or just want to say hello, our team is here to assist you. Please use the form below to get in touch with us. We aim to respond to all inquiries within 24 hours.</p>
            ...
            <div className='row'>
              <div className='col-lg-6 col-md-6 col-sm-6'>
                <br />
              <p className='par'><strong>📍 Our Office</strong><br />
                1st Floor, M.Randhoo,<br />
                Handhuvaree Hingun, Malé<br />
                Republic of Maldives</p>
              </div>
              <div className='col-lg-6 col-md-6 col-sm-6'>
                <p className='par'><strong>🕒 Business Hours</strong><br />
            ...
            <div className='row'>
            <div className='col-lg-6 col-md-6 col-sm-6'>
              <p className='par'><strong>📞 Phone</strong><br />
                  (+960) 910-6006<br />
                  (+960) 944-2123<br />
                  (+960) 968-1231</p>
                </div>
                <div className='col-lg-6 col-md-6 col-sm-6'>
              <p className='par'><strong>📧 Email</strong><br />
          ...
          <div className='col-lg-6 col-md-12 col-sm-12 end'>
            ...
            <div className="follow-us">
              ...
              <p className='par'>Stay connected with us through social media for the latest updates and special offers.</p>
